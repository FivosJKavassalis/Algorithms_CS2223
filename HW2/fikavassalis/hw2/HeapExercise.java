...
public class HeapExercise {
	...
	// Update results, given information for the given trial, data size N, number of
	// comparisons
	...
	public static void main(String[] args) {
		...
		for (int t = 0; t < T; t++) { // 10 trials

			for (int n = 4, idx = 0; n <= 8192; n *= 2, idx++) { // of n 4 to 8192 size heap
				...
				for (int i = 1; i <= 1000; i++) {
					// Remove minimum priority value in priority queue (during which you should
